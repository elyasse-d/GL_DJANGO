...
def search(request):
    ...
    if query == "":
        ...
        # Recherchez les produits dont le titre ou les caractéristiques correspondent à la requête
        product = Product.objects.filter(Q(title__icontains=query) | Q(features__icontains=query))
